/*  What is OOP?
    ...
    ** OOP main pillars are: (Inheritance, Polymorphism, Abstraction, Encapsulation)

    **Concepts Provide by OOP: (Object, Class, Inheritance, Polymorphism, Abstraction, Encapsulation);
